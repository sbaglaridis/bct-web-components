...
@Component({
  tag: 'bct-socials',
  styleUrl: 'bct-socials.css',
  shadow: true,
})
export class BctSocials {
  ...
  getFacebook() {
    return !this.facebook ? '' : (
      <li>
        <a href={this.facebook} rel="nofollow">
  ...
  getTwitter() {
    return !this.twitter ? '' : (
      <li>
        <a href={this.twitter} rel="nofollow">
          <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">
  ...
  getInstagram() {
    return !this.instagram ? '' : (
      <li>
        <a href={this.instagram} rel="nofollow">
          <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">
  ...
  getYoutube() {
    return !this.youtube ? '' : (
      <li>
        <a href={this.youtube} rel="nofollow">
          <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">
            <path d="M512 307.2q0 38.4-12.8 72.534-4.267 12.8-12.8 21.333-17.067 17.067-38.4 17.067c-85.334 8.534-153.6 8.534-234.667 8.534q-76.8 0-153.6-8.534-17.067-4.267-34.133-17.067-12.8-12.8-17.067-29.866-4.266-21.333-4.266-42.666-8.534-72.534 0-145.067c0-25.6 4.266-55.467 25.6-76.8q12.8-12.8 34.133-12.8 93.867-8.534 192-8.534t196.267 8.534c12.8 0 29.866 8.534 38.4 21.333 17.067 25.6 21.333 59.733 21.333 89.6 0 12.8 0 89.6 0 102.4zM341.334 251.734l-136.533-68.267v136.533c46.933-25.6 98.133-46.933 136.533-68.267z"/>
          </svg>
        </a>
      </li>
    )
